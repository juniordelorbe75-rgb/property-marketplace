...
from backend.auth.request_throttle import (
    consume_rate_limit,
    retry_after_detail,
)
...
def _anonymous_rate_limit_key(
    value: str,
) -> str:
    """
    Keep normalized account identifiers
    out of process-local throttle keys.
    """
...
@router.post(
    "/seller-phone-verification/request"
)
...
@router.post(
    "/seller-phone-verification/confirm"
)
...
def update_me(
    ...
    (
        ...
        public_profile_enabled=
            user_data.public_profile_enabled,

        public_name_mode=
            user_data.public_name_mode,

        public_bio_visible=
            user_data.public_bio_visible,
        ...
        seller_category=
            user_data.seller_category,

        seller_phone=
            user_data.seller_phone,
